...
class IaRules(IeRules):
    ...
    SECTION_MARKERS = IeRules.SECTION_MARKERS | {
        "Capitulo", "Articulo", "Paragrapho", "Volumine", "Libro",
    }
    ...
    COMMON_SENT_STARTERS = {
        ...
        # Adverbs
        "Si", "No", "Multo", "Anque", "Etiam", "Solmente", "Semper", "Jamais", "Sovente",
        "Totevia", "Dunque", "Alora", "Postea", "Antea", "Actually", "Finalmente", "Primo",
        "Secundo", "Tertio",
