...
class EoRules(Rules):
    ...
    REFERENCE_ABBRVS = Rules.REFERENCE_ABBRVS | {
        "ĉ", "eld", "p", "pag", "kp", "vd", "v", "rim", "resp", "nr", "ndk",
    }
    ...
    SECTION_MARKERS = Rules.SECTION_MARKERS | {
        "Ĉapitro", "Parto", "Sekcio", "Artikolo", "Paragrafo", "Volumo", "Libro",
    }
    ...
    COMMON_SENT_STARTERS = {
        ...
        # Adverbs
        "Jes", "Ne", "Do", "Tamen", "Eble", "Efektive", "Fakte", "Krome", "Ankaŭ",
        "Sekve", "Tial", "Tuj", "Nun", "Poste", "Antaŭe", "Fine", "Unue", "Due", "Trie",
